                  ...
                  <div className="grid gap-4 lg:grid-cols-[1.2fr_0.8fr_1fr_auto] lg:items-start">
                    <div>
                      ...
                      <div className="mt-3 flex flex-wrap items-center gap-3">
                        ...
                        {openProjects[0] ? <ProjectFollowButton projectId={branch.id} legacyProjectIds={openProjects.map((project) => project.id)} userEmail={user?.email} userRole={user?.role} noun="branch" /> : null}
                      </div>

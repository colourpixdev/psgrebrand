                    ...
                    <div>
                      ...
                      <div className="mt-3 flex w-full flex-wrap items-center gap-3">
                        <div className="flex flex-wrap items-center gap-3">
                          ...
                          {isAdmin ? <button type="button" onClick={(e) => { e.stopPropagation(); beginEdit(branch); }} className="inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-slate-200 transition hover:bg-white/10">Edit</button> : null}
                        </div>
                        {isAdmin ? <button type="button" onClick={(e) => { e.stopPropagation(); requestDelete(branch); }} className="ml-auto inline-flex items-center justify-center rounded-xl border border-red-400/30 bg-red-500/10 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-red-200 transition hover:bg-red-500/20">Remove</button> : null}
                      </div>
